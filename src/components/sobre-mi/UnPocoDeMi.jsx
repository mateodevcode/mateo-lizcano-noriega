  ...
  return (
    <div className="lg:mt-20 md:mt-20 sm:mt-10">
      ...
      <p className="lg:text-xl md:text-xl sm:text-base lg:mt-10 md:mt-10 sm:mt-5">
        ...
        tengo 28 años. Soy un <strong>apasionado por las tecnologías</strong>;
        desde muy pequeño se me dieron bien, pero nunca me imaginé que me
      ...
      <p className="lg:text-xl md:text-xl sm:text-base lg:mt-10 md:mt-10 sm:mt-5">
        Empecé como operario, y gracias a mis buenas bases en Excel, me fueron
        dando más responsabilidades hasta llegar al cargo de ingeriero de
        planeación. Con las responsabilidades llegaron los retos, mejores pagos
        y más experiencia. Un día, mi curiosidad me llevó a automatizar muchas
        tareas manuales en Excel, y{" "}
        <strong className="text-red-700">
          {" "}
          recuerdo haber anidado 64 <i>IF</i> dentro de un archivo
        </strong>
        ...
        usando <strong>HTML y CSS</strong>. Era <i>muy básica</i>, pero fue mi
        comienzo.
      </p>

      <p className="lg:text-xl md:text-xl sm:text-base lg:mt-10 md:mt-10 sm:mt-5">
        A medida que investigaba, sentía que con cada línea de código que
        escribía, me acercaba más a mi sueño de ser desarrollador. Cuando tuve
        mi primera oportunidad de pasarme al área de desarrollo de software
      ...
      <p className="lg:text-xl md:text-xl sm:text-base lg:mt-10 md:mt-10 sm:mt-5">
        Fue una decisión difícil, pero sabía que si no tomaba la oportunidad de
        estudiar en el exterior, me arrepentiría más adelante. Decidí venirme a
        España y empezar una nueva etapa en mi vida. Renuncié a mi trabajo, tomé
        lo que tenía ahorrado, más unos préstamos que hice en los bancos, y me
        vine. Desde el momento en que decidí venirme hasta el día de hoy, no he
        parado de seguir aprendiendo.
      </p>

      <p className="lg:text-xl md:text-xl sm:text-base lg:mt-10 md:mt-10 sm:mt-5">
        Cuando partí de Colombia, ya me había inmerso un poco en ciberseguridad,
        puesto que fui, durante un tiempo, víctima de un ataque de suplantación
      ...
      <p className="lg:text-xl md:text-xl sm:text-base lg:mt-10 md:mt-10 sm:mt-5">
        Antes de venirme a España, ya dedicaba muchas horas por las noches,
        después de llegar del trabajo, a estudiar{" "}
        <strong className="text-blue-500">programación</strong> y
        <strong className="text-green-600"> ciberseguridad</strong>. Decidí que
        en algún momento de mi vida me dedicaría de lleno a esto, pues lo
        disfruto, y ya estando en España, cada espacio que tenía lo dedicaba a
        estudiar. Empecé con los típicos canales en YouTube, cursos de{" "}
        <Link href={"https://platzi.com/"} target="_blank">
          <strong className="text-green-800">Platzi</strong>
        </Link>
        , y fui encontrando una comunidad grande que me ayudó a seguir adelante
        siempre que tenía algún fallo.
      </p>
      ...
      <p className="lg:text-xl md:text-xl sm:text-base lg:mt-10 md:mt-10 sm:mt-5">
        ...
        <Link href={"https://www.youtube.com/@FaztTech"} target="_blank">
          <strong className="text-red-600">Fazt</strong>
        </Link>
        ,{" "}
        <Link href={"https://www.youtube.com/@s4vitar"} target="_blank">
          <strong className="text-red-600">Savitar</strong>
        </Link>
        ,{" "}
        <Link
